...
!(function(t, n) {
  ...
  function n(t, n) {
    if (
      (r = (t = n ? t.toExponential(n - 1) : t.toExponential()).indexOf("e")) <
      0
    )
      return null;
    var r,
  ...
  var s = {
    ...
    s: function(t, r) {
      ...
      var o = i[0],
        a = i[1],
        u = a - (e = 3 * Math.max(-8, Math.min(8, Math.floor(a / 3)))) + 1,
        s = o.length;
      return u === s
        ? o
        : u > s
        ...
        : "0." + new Array(1 - u).join("0") + n(t, Math.max(0, r + u - 1))[0];
    },
    X: function(t) {
      return Math.round(t)
        .toString(16)
  ...
  function m(n) {
    return (
      (f = l(n)), (t.format = f.format), (t.formatPrefix = f.formatPrefix), f
    );
  }
  m({ decimal: ".", thousands: ",", grouping: [3], currency: ["$", ""] }),
